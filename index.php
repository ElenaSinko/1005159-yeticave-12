        ...
        <ul class="lots__list">
            ...
            <li class="lots__item lot">
                <div class="lot__image">
                    <img src=<?php print($val['img']); ?> width="350" height="260" alt="<?php print($val['title']); ?>">
                </div>
                <div class="lot__info">
                    <span class="lot__category"><?php print($val['category']); ?></span>
                    <h3 class="lot__title"><a class="text-link" href="pages/lot.html"><?php print($val['title']); ?></a></h3>
                    <div class="lot__state">
                        <div class="lot__rate">
                            <span class="lot__amount">Стартовая цена</span>
                            <span class="lot__cost"><?php print($val['price']); ?><b class="rub">р</b></span>
                        </div>
